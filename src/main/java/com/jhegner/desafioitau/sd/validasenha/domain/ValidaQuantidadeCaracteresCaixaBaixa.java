...
public class ValidaQuantidadeCaracteresCaixaBaixa extends ValidaSenha{

    // pode ser configurado em prop. ou banco
    private static final int QUANTIDADE_CARACTERES_CAIXA_BAIXA_MINIMA = 1;
    ...
    public boolean validar(String senha) {
        ...
        for(char caracter : caracteres){
            ...
            if(collator.compare(String.valueOf(caracter),
                    String.valueOf(caracter).toLowerCase()) == 0) {
                contador+=1;
            }
        }

        return contador >= QUANTIDADE_CARACTERES_CAIXA_BAIXA_MINIMA;
    }
}
